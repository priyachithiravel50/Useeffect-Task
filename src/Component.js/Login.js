    ...
    <div style={{display:'flex'}}> 
      ...
      {/* <i className="fa-solid fa-user-circle" id="server" ></i> */}
        ...
        <div style={{ marginBottom: '15px', textAlign: 'left' }}>
          <label>Name:</label>
          <input type="text" id="Name" placeholder='Name' value={formik.values.Name} onChange={formik.handleChange} />
        ...
        <div style={{ position: 'relative' }}>
          <input type={showPassword ? 'text' : 'password'} id="Password" placeholder='Password' autoComplete="off" value={formik.values.Password} onChange={formik.handleChange} />
